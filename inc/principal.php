...
if ( isset( $_SESSION['usuario'] ) ) {
    ...
    ?>
	<div id="registro" class='span-14 prepend-5 append-5'>
	<img src='imagenes/logotipo2.png'
        width='538px' alt='The Perfect Place' />
    <form id='login_name' name='login_name' method='post' action='inc/validacion.php'>
    	<fieldset>
    	<?php 
    if ( isset( $_SESSION['error'] ) ) {
    	...
    	<p>
    		<label for='usuario' class='text span-3'>Usuario:</label>
    		<input type='text' class='text' id='usuario' name='usuario' />
    	</p>
    	<p>
    		<label for='password' class='text span-3'>Contraseña:</label>
    	...
    	<p>
    	<span class="etiqueta">Desarrollado por:</span></p>
