...
if(isset($_POST))
	...
	switch($_POST[opcion])
		{
		case 0:$respuesta=cabezera("mensual",$_POST)."".generales()."".opciones(0)."".botones()."</table>";break;
		case 1:$respuesta=cabezera("puntual",$_POST)."".generales()."".opciones(1)."".botones()."</table>";break;
		}
	echo $respuesta;
	}
	else
