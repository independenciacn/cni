...
if($_GET[mes] <= 9)
	...
	$cadena .= "<tr bgcolor='#bbbbbb'><th colspan='7'>Listado de Servicios de ".$cliente_servicios[1]." en ".$mes_servicios." de ".$_GET[anyo]."</th></tr>";
...
//acumulados
		...
		<td ".$color."><p class='texto'>".ucfirst($resultado[2])." ".ucfirst($resultado[6])."</p></td>
...
//fin acumulados
		...
		<td ".$color."><p class='texto'>".ucfirst($resultado[0])." ".ucfirst($resultado[7])."</p></td>
