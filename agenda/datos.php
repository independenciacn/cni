...
if (isset($_POST['opcion'])) {
    switch ($_POST['opcion']) {
        case 0:$respuesta=formulario_despacho($_POST);
        break;
        case 1:$respuesta=cuca($_POST);
        break;
        case 2:$respuesta=dame_nombre_cliente($_POST);
        break;
...
function formulario_despacho($vars)
{
    ...
    $cadena .="Cliente:<input type='text' name='cliente' id='cliente' autocomplete='off' onkeyup='busca_cliente()' value='$cliente' />
    <div id='listado_clientes_agenda'></div>";
    $cadena .="Otro:&nbsp;&nbsp;&nbsp;<input type='text' name='no_cliente' id='no_cliente' value='$vars[otro]'/><p/>";
