 ...
 * @return string
 */
function cambiaf($fecha, $origen = 'Y-m-d', $destino = 'd-m-Y')
{
    $date = date_create_from_format($origen, $fecha, new DateTimeZone('Europe/Madrid'));
    return $date->format($destino);
}
