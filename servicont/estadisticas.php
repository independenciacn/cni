...
function mes($modo)
{
    ...
    //FIXME cambiarlo a foreach con meses
    for ($i = 1; $i <= 12; $i ++) {
...
function formulario($vars)
{
    ...
    $cadena = "<form name='consulta' id='consulta' method='post' action='#'>";
